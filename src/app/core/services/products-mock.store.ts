...
export class ProductsMockStore {
  private readonly productsSignal = signal<ProductMock[]>([
    ...
    { id: 'prod-21', titre: 'Écouteurs Bluetooth', categorie: 'Électronique', ville: 'Douala', prix: 18500, descriptionCourte: 'Écouteurs ultraportables avec réduction de bruit.', descriptionDetaillee: 'Écouteurs sans fil, 24h d\'autonomie. Confort optimisé pour les longues sessions.', imagePrincipale: IMG(3394666), galerie: [IMG(3394653), IMG(3394665)], createdAt: Date.now() - 1000 * 60 * 50, note: 4.4, nbAvis: 567, prixBarre: 22000, livraisonGratuite: true },
    { id: 'prod-22', titre: 'Jean slim', categorie: 'Mode', ville: 'Yaoundé', prix: 15000, descriptionCourte: 'Jean slim stretch, coupe moderne.', descriptionDetaillee: 'Jean confortable en coton stretch. Taille ajustée.', imagePrincipale: IMG(1598505), galerie: [IMG(2529148), IMG(8979070)], createdAt: Date.now() - 1000 * 60 * 120, note: 4.3, nbAvis: 234, livraisonGratuite: false },
    { id: 'prod-23', titre: 'Grille-pain 2 fentes', categorie: 'Cuisine', ville: 'Bafoussam', prix: 12500, descriptionCourte: 'Grille-pain compact avec 6 niveaux de cuisson.', descriptionDetaillee: 'Grille-pain économique, plaques antiadhésives amovibles.', imagePrincipale: IMG(3738095), galerie: [IMG(3738093), IMG(3951628)], createdAt: Date.now() - 1000 * 60 * 90, note: 4.5, nbAvis: 189, livraisonGratuite: true },
    { id: 'prod-24', titre: 'Webcam HD 1080p', categorie: 'Informatique', ville: 'Douala', prix: 35000, descriptionCourte: 'Webcam Full HD pour visioconférence.', descriptionDetaillee: 'Webcam avec micro intégré, pivot réglable.', imagePrincipale: IMG(2054219), galerie: [IMG(2115257), IMG(1181298)], createdAt: Date.now() - 1000 * 60 * 70, note: 4.6, nbAvis: 312, prixBarre: 42000, livraisonGratuite: true },
    { id: 'prod-25', titre: 'Table de chevet', categorie: 'Maison', ville: 'Yaoundé', prix: 28000, descriptionCourte: 'Table de chevet en bois avec tiroir.', descriptionDetaillee: 'Table de chevet design épuré, tiroir de rangement.', imagePrincipale: IMG(1586996), galerie: [IMG(923311), IMG(284951)], createdAt: Date.now() - 1000 * 60 * 100, note: 4.2, nbAvis: 89, livraisonGratuite: false },
    { id: 'prod-26', titre: 'Enceinte portable', categorie: 'Électronique', ville: 'Douala', prix: 42000, descriptionCourte: 'Enceinte Bluetooth waterproof, 20W.', descriptionDetaillee: 'Enceinte portable waterproof IPX7, batterie 12h.', imagePrincipale: IMG(3394666), galerie: [IMG(788946), IMG(404280)], createdAt: Date.now() - 1000 * 60 * 85, note: 4.7, nbAvis: 456, livraisonGratuite: true },
    { id: 'prod-27', titre: 'Robe d\'été', categorie: 'Mode', ville: 'Bafoussam', prix: 18500, descriptionCourte: 'Robe légère en coton, coupe fluide.', descriptionDetaillee: 'Robe confortable pour l\'été, coupe universelle.', imagePrincipale: IMG(5477693), galerie: [IMG(5622571), IMG(6769347)], createdAt: Date.now() - 1000 * 60 * 60, note: 4.4, nbAvis: 123, livraisonGratuite: true },
    { id: 'prod-28', titre: 'Bouilloire électrique', categorie: 'Cuisine', ville: 'Yaoundé', prix: 15000, descriptionCourte: 'Bouilloire 1,7 L, arrêt automatique.', descriptionDetaillee: 'Bouilloire rapide, base 360°, sécurité anti-débordement.', imagePrincipale: IMG(2719464), galerie: [IMG(29510333), IMG(19651262)], createdAt: Date.now() - 1000 * 60 * 110, note: 4.5, nbAvis: 278, livraisonGratuite: true },
    { id: 'prod-29', titre: 'Support PC portable', categorie: 'Informatique', ville: 'Douala', prix: 12000, descriptionCourte: 'Support ventilé pour ordinateur portable.', descriptionDetaillee: 'Support ergonomique avec ventilation, réglable en hauteur.', imagePrincipale: IMG(1181298), galerie: [IMG(18105), IMG(2054219)], createdAt: Date.now() - 1000 * 60 * 95, note: 4.3, nbAvis: 167, livraisonGratuite: true },
    { id: 'prod-30', titre: 'Plaque chauffante', categorie: 'Cuisine', ville: 'Bafoussam', prix: 22000, descriptionCourte: 'Plaque électrique 2 zones, induction.', descriptionDetaillee: 'Plaque induction 2 zones, commandes tactiles.', imagePrincipale: IMG(2246476), galerie: [IMG(2717167), IMG(3182757)], createdAt: Date.now() - 1000 * 60 * 80, note: 4.6, nbAvis: 189, livraisonGratuite: false },
    { id: 'prod-31', titre: 'Raspberry Pi 4', categorie: 'Informatique', ville: 'Yaoundé', prix: 55000, descriptionCourte: 'Mini PC 4 Go RAM pour projets DIY.', descriptionDetaillee: 'Raspberry Pi 4, processeur Quad-core, WiFi et Bluetooth.', imagePrincipale: IMG(2115257), galerie: [IMG(1181298), IMG(18105)], createdAt: Date.now() - 1000 * 60 * 45, note: 4.8, nbAvis: 234, livraisonGratuite: true },
    { id: 'prod-32', titre: 'Couverture polaire', categorie: 'Maison', ville: 'Douala', prix: 9500, descriptionCourte: 'Couverture douce 150x200 cm.', descriptionDetaillee: 'Couverture polaire ultra-douce, lavable en machine.', imagePrincipale: IMG(1598505), galerie: [IMG(5477693), IMG(6769347)], createdAt: Date.now() - 1000 * 60 * 130, note: 4.2, nbAvis: 445, livraisonGratuite: true },
    { id: 'prod-33', titre: 'Tap Isométrique', categorie: 'Mode', ville: 'Bafoussam', prix: 8500, descriptionCourte: 'Tapis de yoga antidérapant 6 mm.', descriptionDetaillee: 'Tapis yoga écologique, surface antidérapante.', imagePrincipale: IMG(2529148), galerie: [IMG(1598505), IMG(8979070)], createdAt: Date.now() - 1000 * 60 * 140, note: 4.4, nbAvis: 312, livraisonGratuite: false },
    { id: 'prod-34', titre: 'Presse-agrumes', categorie: 'Cuisine', ville: 'Yaoundé', prix: 18000, descriptionCourte: 'Presse-agrumes électrique, grand bol.', descriptionDetaillee: 'Presse-agrumes pour oranges et citrons, collecteur 1,2 L.', imagePrincipale: UIMG('1564940735784-b15466e8dc09'), galerie: [IMG(3738095), IMG(2719464)], createdAt: Date.now() - 1000 * 60 * 75, note: 4.5, nbAvis: 198, livraisonGratuite: true },
    { id: 'prod-35', titre: 'Étagère 5 niveaux', categorie: 'Maison', ville: 'Douala', prix: 25000, descriptionCourte: 'Étagère métallique pour rangement.', descriptionDetaillee: 'Étagère robuste 5 niveaux, montage facile.', imagePrincipale: IMG(416320), galerie: [IMG(1957477), IMG(236712)], createdAt: Date.now() - 1000 * 60 * 160, note: 4.3, nbAvis: 76, livraisonGratuite: false }
  ]);
