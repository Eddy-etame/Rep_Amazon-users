...
import type { CatalogProduct } from '../../core/services/depot-catalogue-produits';
...
import { ServiceFavoris } from '../../core/services/service-favoris';
...
@Component({
  ...
  imports: [CommonModule, RouterLink, PipeDeviseAmaz],
  templateUrl: './page-favoris.html',
...
export class PageFavoris implements OnInit {
  ...
  constructor(
    ...
    private readonly wishlistStore: DepotFavoris,
